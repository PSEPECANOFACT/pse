...
| **IndicadorVehiculoConductoresTransp**  <br>`condicional`  <br>`number` | Indicador de registro de vehículos y conductores del transportista. | Los valores son 1 (Sí) o 0 (No). |
...
| **NumeroRegistroMtc**  <br>`condicional`  <br>`string` | Número de Registro MTC - Transportista. | Alfanumérico hasta 20 caracteres.  <br>Solo letras mayúsculas y números.  <br>Solo para modalidad de traslado 'Transporte público' y que no exista el 'Indicador de traslado de vehículos de categoría M1 o L'. |
| **NumeroAutorizacionEspecialTransportista**  <br>`opcional`  <br>`string` | Número de autorización especial emitido por la entidad - Transportista. | Alfanumérico de 3 a 50 caracteres. |
| **EntidadEmisoraAutorizacionTransportista**  <br>`opcional`  <br>`number` | Entidad emisora de la autorización especial - Transportista.  <br>[[Ver listado]](../Listado/EntidadEmisoraAutorizacionEspecial.md) | Catálogo D-37. |
| **Vehiculos**  <br>`condicional`  <br>`array` | Vehículos principal y hasta dos secundarios.  <br>[[Ver entidad]](../Entidad/Vehiculo.md) | Hasta un máximo de 3 vehículos.  <br><u>_Obligatorio_</u> cuando la modalidad de traslado es 'Transporte Público', no existe el 'Indicador de traslado de vehículos en la categoría M1 o L', pero existe el 'Indicador de registro de vehículos y conductores del transportista'; o cuando la modalidad de traslado es 'Transporte Privado', pero no existe el 'Indicador de traslado de vehículos en la categoría M1 o L'.  <br><u>_No se debe ingresar_</u> cuando la modalidad de traslado es 'Transporte Público', no existe el 'Indicador de traslado de vehículos en la categoría M1 o L', y tampoco existe el 'Indicador de registro de vehículos y conductores del transportista'. |
| **Conductores**  <br>`condicional`  <br>`array` | Conductores principal y hasta dos secundarios.  <br>[[Ver entidad]](../Entidad/Conductor.md) | Hasta un máximo de 3 conductores.  <br><u>_Obligatorio_</u> cuando la modalidad de traslado es 'Transporte Público', no existe el 'Indicador de traslado de vehículos en la categoría M1 o L', pero existe el 'Indicador de registro de vehículos y conductores del transportista'; o cuando la modalidad de traslado es 'Transporte Privado', pero no existe el 'Indicador de traslado de vehículos en la categoría M1 o L'.  <br><u>_No se debe ingresar_</u> cuando la modalidad de traslado es 'Transporte Público', no existe el 'Indicador de traslado de vehículos en la categoría M1 o L', y tampoco existe el 'Indicador de registro de vehículos y conductores del transportista'. |
