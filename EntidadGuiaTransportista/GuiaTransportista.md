...
| --- | --- | --- |
| **NumeroDocumento**  <br>`obligatorio`  <br>`string` | Serie y correlativo del comprobante.  <br>**Ejemplo:**  <br>V001-00000001 | Alfanumérico de 13 caracteres. |
...
| **IndicadorPagadorFleteRemitente**  <br>`condicional`  <br>`number` | Indicador de pagador de flete - Tercero. | Los valores son 1 (Sí) o 0 (No).  <br>Si se consigna un valor en este indicador (1), los indicadores 'IndicadorPagadorFleteSubcontratador' e 'IndicadorPagadorFleteTercero' deben ser ceros (0).  <br>Los indicadores para "Pagador de fletes" son excluyentes entre sí. |
| **IndicadorPagadorFleteSubcontratador**  <br>`condicional`  <br>`number` | Indicador de pagador de flete - Subcontratador. | Los valores son 1 (Sí) o 0 (No).  <br>Si se consigna un valor en este indicador (1), los indicadores 'IndicadorPagadorFleteRemitente' e 'IndicadorPagadorFleteTercero' deben ser ceros (0).  <br>Los indicadores para "Pagador de fletes" son excluyentes entre sí. |
| **IndicadorPagadorFleteTercero**  <br>`condicional`  <br>`number` | Indicador de pagador de flete - Tercero. | Los valores son 1 (Sí) o 0 (No).  <br>Si se consigna un valor en este indicador (1), los indicadores 'IndicadorPagadorFleteRemitente' e 'IndicadorPagadorFleteSubcontratador' deben ser ceros (0).  <br>Los indicadores para "Pagador de fletes" son excluyentes entre sí. |
| **Subcontratador**  <br>`condicional`  <br>`object` | Datos de empresa que subcontrata.  <br>[[Ver entidad]](../Entidad/SubcontratadorGRT.md) | Solo se completa cuando 'IndicadorTrasporteSubcontratado = 1'. |
| **PagaServicioTransporte**  <br>`condicional`  <br>`object` | Datos quien paga el servicio de transporte.  <br>[[Ver entidad]](../Entidad/PagaServicioTransporteGRT.md) | Solo se completa cuando paga un tercero; es decir, cuando 'IndicadorPagadorFleteTercero = 1'. |
