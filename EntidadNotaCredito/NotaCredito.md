...
| **Cliente**  <br>`obligatorio`  <br>`object` | Datos del adquiriente o usuario.  <br>[[Ver entidad]](../Entidad/Adquiriente.md) |  |
...
| **DetalleNotaCredito**  <br>`obligatorio`  <br>`object` | Datos del detalle o ítem de la nota de crédito.  <br>[[Ver entidad]](../EntidadNotaCredito/NotaCreditoDetalle.md) |  |
